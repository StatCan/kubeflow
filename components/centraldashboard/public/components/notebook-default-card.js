 ...
 */
// eslint-disable-next-line max-len
export class NotebookDefaultCard extends mixinBehaviors([AppLocalizeBehavior], utilitiesMixin(PolymerElement)) {
    static get template() {
        return html([`
...
window.customElements.define('notebook-default-card', NotebookDefaultCard);
